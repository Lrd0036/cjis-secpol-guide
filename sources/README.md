...
Use [`RESEARCH-NOTES.md`](RESEARCH-NOTES.md) for evidence classes and maintenance rules. Use the [Texas DPS acquisition manifest](manifests/texas-dps-cjis-documents.md) to verify the files downloaded from the Texas DPS collection. The [local import manifest](manifests/local-imports.md) records source material whose original acquisition URL is not known.
